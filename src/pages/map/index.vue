<template>
    <div class="map">
        ...
        <map class="content" id="map" longitude="118.236716" latitude="28.687000" :markers="markers" scale="18" @tap="toNav">
        </map>
        <div class="call">
...
<script>
    export default{
        ...
        methods:{
            ...
            linkHe(){
                wx.makePhoneCall({
                    phoneNumber: '15001994232'
                })
            },
            linkShe(){
                wx.makePhoneCall({
                    phoneNumber: '18370338609'
                })
            }
        }
    }
